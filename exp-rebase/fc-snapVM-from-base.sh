...
## for control bash
rootfs_path="/home/ssl/rootfs/debian-rootfs.ext4"
arch=`uname -m`
...
curl --unix-socket $socket_path -i \
	...
	-d '{
		"snapshot_type": "Diff",
		"snapshot_path": "/home/ssl/snapshot/torch/torch.snapshot",
		"mem_file_path": "/home/ssl/snapshot/torch/torch.mem_file",
		"version": "1.0.0"
	}'
